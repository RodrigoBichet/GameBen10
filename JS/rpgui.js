RPGUI = (function () {
    ...
    RPGUI.create = function (element, rpgui_type) {
        ...
        // not a valid type? exception.
            ...
            throw (
                "Not a valid rpgui type! options: " +
    ...
    function create_progress(elem) {
        ...
        var starting_val =
            elem.dataset.value !== undefined
                ? parseFloat(elem.dataset.value)
                : 1;
            ...
            (function (elem, option, item, select_header, list) {
                ...
                item.addEventListener("click", function () {
                    ...
                    select_header.innerHTML =
                        arrow_down_prefix + option.innerHTML;
                    list.style.display = "none";
    ...
    function create_slider(elem) {
        ...
        (function (
            ...
            function slide(pos) {
                ...
                var new_val =
                    min + Math.round((pos / track_width) * (max - min)) - 1;
    ...
    */
    ...
    RPGUI.insert_after = function (to_insert, after_element) {
        after_element.parentNode.insertBefore(
            to_insert,
            after_element.nextSibling
        );
    };
    return RPGUI;
})();
